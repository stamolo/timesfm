...
def main():
    ...
    try:
        ...
        # Открытие CSV-файла для записи результатов с кодировкой utf-8-sig
        # Это ключевое изменение для корректного отображения кириллицы в Excel
        with open('D:\\output1.csv', 'w', newline='', encoding='utf-8-sig') as f:
